  ...
  return (
    <SafeAreaView>
      ...
      <SafeAreaView style={styles.contWrp}>
        <View>
          <Text style={styles.titText}>Login</Text>
        </View>
        ...
        <View style={styles.auth}>
          <Pressable onPress={handePress} style={styles.loginPress}>
            <Text style={styles.hdText}>Login</Text>
          </Pressable>
          <Pressable
            onPress={() => {
              navigation.navigate('Register');
          ...
          <Pressable
            onPress={() => {
              navigation.navigate('ForgottPswd');
            }}>
